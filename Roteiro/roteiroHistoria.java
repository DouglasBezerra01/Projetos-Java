...
public class roteiroHistoria {
    public static void main(String[] args) {
        ...
        cap00.escolhas.add(new Escolha("Escolher classe guerreiro\n", capG00));
        ...
        capG00.escolhas.add(new Escolha("Procurar entrada para uma antiga caverna\\n", capG01));
        ...
        capG01.escolhas.add(new Escolha("Procurar pela fortaleza\n", capG011));
        ...
        capG01.escolhas.add(new Escolha("Lutar valentemente\n", capG012));
        ...
        capG00.escolhas.add(new Escolha("Procurar templo sagrado nas monstanhas\n", capG02));
        ...
        capG02.escolhas.add(new Escolha("Enfrentar os inimigos menores primeiro\n", capG021));
        ...
        capG02.escolhas.add(new Escolha("Lutar de frente com o líder maligno\n", capG022));
        ...
        cap00.escolhas.add(new Escolha("Escolher classe feiticeira\n", capF00));
        ...
        capF00.escolhas.add(new Escolha("Pesquisar em registros antigos\n", capF01));
        ...
        capF01.escolhas.add(new Escolha("Lutar diretamente com o vil\u00E3o no covil\n", capF011));
        ...
        capF01.escolhas.add(new Escolha("Esgueirar-se pelo covil para emboscar o vilão\n", capF012));
        ...
        capF00.escolhas.add(new Escolha("Usar leituras de visão\n", capF02));
        ...
        capF02.escolhas.add(new Escolha("Lutar diretamente com o vilão no covil\n", capF021));
        ...
        capF02.escolhas.add(new Escolha("Esgueirar-se pelo covil para emboscar o vilão\n", capF022));
