...
public class roteiroHistoria {
    public static void main(String[] args) {
        ...
        cap00.escolha1 = "Para escolher a classe guerreiro\n";
        cap00.escolha2 = "Para escolher a classe feiticeiro\n";
        cap00.mostrar(jogador);

        if (cap00.escolha(leitor) == 1) { // História do guerreiro

            Capitulo capG01 = new Capitulo();
            ...
            capG01.escolha1 = "Procurar entrada para uma antiga caverna\n";
            capG01.escolha2 = "Procurar templo sagrado nas monstanhas\n";
            capG01.mostrar(jogador);

            if (capG01.escolha(leitor) == 1) { // História 1 do guerreiro
                Capitulo capG02 = new Capitulo();
                ...
                capG02.escolha1 = "Procurar pela fortaleza\n";
                capG02.escolha2 = "Lutar valentemente\n";
                capG02.mostrar(jogador);

                if (capG02.escolha(leitor) == 1) { // Final 1.1 guerreiro
                    System.out.println(
                ...
                capG03.escolha1 = "Para escolher a classe guerreiro\n";
                capG03.escolha2 = "Para escolher a classe feiticeiro\n";
                capG03.mostrar(jogador);

                if (capG03.escolha(leitor) == 1) { // Final 2.1 guerreiro
                    System.out.println(
            ...
            capF01.escolha1 = "Pesquisar em registros antigos\n";
            capF01.escolha2 = "Usar leituras de visão\n";
            capF01.mostrar(jogador);

            if (capF01.escolha(leitor) == 1) { // História 1 da feiticeira
                Capitulo capF02 = new Capitulo();
                ...
                capF02.escolha1 = "Lutar diretamente com o vilão no covil\n";
                capF02.escolha2 = "Esgueirar-se pelo covil para emboscar o vilão\n";
                capF02.mostrar(jogador);

                if (capF02.escolha(leitor) == 1) { // Final 1.1 feiticeira
                    System.out.println(
                ...
                capF03.escolha1 = "Lutar diretamente com o vilão no covil\n";
                capF03.escolha2 = "Esgueirar-se pelo covil para emboscar o vilão\n";
                capF03.mostrar(jogador);

                if (capF03.escolha(leitor) == 1) {
                    System.out.println(
